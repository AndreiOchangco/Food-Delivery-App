...
import SectionTwoDetails from '../../data/SectionTwoDetails.js';

const AboutSectionTwo = ({ route }) => {
            ...
            <FlatList
                ...
                <>
                    <View style={styles.headerView}>
                        <Text style={[styles.bodyHeader, {color: isDarkMode ? 'white' : 'black' }]}>What’s In Your Food</Text>
                        <Image
                        source={require('../../assets/About/2_Pub_Whats_In_Your_Food.jpg')}
                        style={styles.headerLogo}
                         />
                    </View>
                    <View style={styles.bodyView}>
                        <Text style={[styles.bodyTextHeader, {color: isDarkMode ? 'white' : 'black' }]}>What’s In Your Food</Text>
