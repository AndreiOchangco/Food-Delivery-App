...
import CategoryFiveDetails from '../../data/CategoryFiveDetails.js';
import { ThemeContext } from '../../context/ThemeContext.js';

const MenuCategoryFive = () => {
          ...
          <View style={[styles.headerContainer, { backgroundColor: isDarkMode ? '#1e1e1e' : 'white' }]}>
            ...
            <FlatList
                ...
                <View style={styles.headerView}>
                    ...
                    />
                    <Text style={[styles.headerText, { color: isDarkMode ? '#fff' : '#000' }]}>Fries & Sides</Text>
                </View>
                }
                data={CategoryFiveDetails}
...
export default MenuCategoryFive;