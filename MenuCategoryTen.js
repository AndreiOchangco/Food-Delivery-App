...
import CategoryTenDetails from '../../data/CategoryTenDetails.js';
import { ThemeContext } from '../../context/ThemeContext.js';

const MenuCategoryTen = () => {
          ...
          <View style={[styles.headerContainer, { backgroundColor: isDarkMode ? '#1e1e1e' : 'white' }]}>
            ...
            <FlatList
                ...
                <View style={styles.headerView}>
                    ...
                    />
                    <Text style={[styles.headerText, { color: isDarkMode ? '#fff' : '#000' }]}>Minecraft Movie Meals</Text>
                </View>
                }
                data={CategoryTenDetails}
...
export default MenuCategoryTen;