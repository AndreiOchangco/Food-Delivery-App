...
import CategorySevenDetails from '../../data/CategorySevenDetails.js';
import { ThemeContext } from '../../context/ThemeContext.js';

const MenuCategorySeven = () => {
          ...
          <View style={[styles.headerContainer, { backgroundColor: isDarkMode ? '#1e1e1e' : 'white' }]}>
            ...
            <FlatList
                ...
                <View style={styles.headerView}>
                    ...
                    />
                    <Text style={[styles.headerText, { color: isDarkMode ? '#fff' : '#000' }]}>Beverages</Text>
                </View>
                }
                data={CategorySevenDetails}
...
export default MenuCategorySeven;