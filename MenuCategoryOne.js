...
import CategoryOneDetails from '../../data/CategoryOneDetails.js';
      ...
      <FlatList
        ListHeaderComponent={
          <View style={styles.headerView}>
            <Image
              source={require('../../assets/Menu/Hero_QPC1.jpg')}
              style={styles.headerLogo}
            />
            <Text style={[styles.headerText, { color: isDarkMode ? '#fff' : '#000' }]}>Burgers</Text>
          </View>
        }
        data={CategoryOneDetails}
