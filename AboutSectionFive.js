...
import SectionFiveDetails from '../../data/SectionFiveDetails.js';

const AboutSectionFive = ({ route }) => {
            ...
            <FlatList
                ...
                <>
                    <View style={styles.headerView}>
                        <Text style={[styles.bodyHeader, {color: isDarkMode ? 'white' : 'black' }]}>Meet Our Food Experts</Text>
                        <Image
                        source={require('../../assets/About/Our_Food_Experts_2-col.jpg')}
