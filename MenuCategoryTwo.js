...
import CategoryTwoDetails from '../../data/CategoryTwoDetails.js';
          ...
          <View style={[styles.headerContainer, { backgroundColor: isDarkMode ? '#1e1e1e' : 'white' }]}>
            ...
            <FlatList
                ...
                <View style={styles.headerView}>
                    <Image
                    source={require('../../assets/Menu/2_Pub_CrispyChicken_CommitmentToQuality.jpg')}
                    style={styles.headerLogo}
                    />
                    <Text style={[styles.headerText, { color: isDarkMode ? '#fff' : '#000' }]}>Chicken & Fish Sandwiches</Text>
                </View>
                }
                data={CategoryTwoDetails}
...
export default MenuCategoryOne;