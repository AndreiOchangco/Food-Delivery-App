...
import CategoryFourDetails from '../../data/CategoryFourDetails.js';
import { ThemeContext } from '../../context/ThemeContext.js';

const MenuCategoryFour = () => {
          ...
          <View style={[styles.headerContainer, { backgroundColor: isDarkMode ? '#1e1e1e' : 'white' }]}>
            ...
            <FlatList
                ...
                <View style={styles.headerView}>
                    ...
                    />
                    <Text style={[styles.headerText, { color: isDarkMode ? '#fff' : '#000' }]}>McNuggets®</Text>
                </View>
                }
                data={CategoryFourDetails}
...
export default MenuCategoryFour;