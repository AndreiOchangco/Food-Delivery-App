...
import CategoryThreeDetails from '../../data/CategoryThreeDetails.js';
import { ThemeContext } from '../../context/ThemeContext.js';

const MenuCategoryThree = () => {
          ...
          <View style={[styles.headerContainer, { backgroundColor: isDarkMode ? '#1e1e1e' : 'white' }]}>
            ...
            <FlatList
                ...
                <View style={styles.headerView}>
                    ...
                    />
                    <Text style={[styles.headerText, { color: isDarkMode ? '#fff' : '#000' }]}>Breakfast</Text>
                </View>
                }
                data={CategoryThreeDetails}
...
export default MenuCategoryThree;